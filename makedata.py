...
PEOPLE = [
    ('John', 'Doe', 'Fishing,Biking',
        '12345', 'jodo@example.com', '1, Sample Street\n123ABC Stonehenge',),
    ('Jane', 'Doe', 'Biking,Videogames',
        '12345', 'jado@example.com', '1, Sample Street\n123ABC Stonehenge',),
    ('Karl', 'Mustermann', 'Fitness,Cooking,Football',
        '11223', 'musti@example.com', '2A Schlossallee\n123 Brett',),
    ('Anna', 'Musterfrau', 'Häkeln,Cooking',
        '11223', 'musti@example.com', '22 Ostbahnhof\n111 Brett',),
]
...
def make_lookup_table():
    ...
    with open('slides/_static/city_lookup_people.csv', 'w') as outfile:
        ...
        header = ['First Name', 'Last Name',
                  'Hobbies', 'Phone #', 'email', 'Address', 'City ID']
