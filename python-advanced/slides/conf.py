...
# sphinx-quickstart on Tue Feb  9 08:07:21 2016.
#
...
project = u'Python'
copyright = u'2016, Michel Albert'
...
texinfo_documents = [
  ('index', 'Python', u'Python Documentation',
   u'Michel Albert', 'Python', 'One line description of project.',
   'Miscellaneous'),
]
...
slide_theme_options = {
    ...
    # TODO 'google_analytics': 'UA-54507261-1',
}
