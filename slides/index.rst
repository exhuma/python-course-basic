...
.. ifnotslides::
   ...
   +-----------------------------------+-------+------+-------+------+---------+
   | Description                       | Basic | Adv. | Level | Docs | Example |
   +===================================+=======+======+=======+======+=========+
   ...
   | decorators                        |       | ✓    | ★★★   | d    | c       |
   +-----------------------------------+-------+------+-------+------+---------+
   | "magic" Variables and attributes  |       | ✓    | ★★☆   | d    | c       |
   +-----------------------------------+-------+------+-------+------+---------+
   | logging                           |       | ✓    | ★★☆   | d    | c       |
   +-----------------------------------+-------+------+-------+------+---------+
   | unit tests                        |       | ✓    | ★★☆   | d    | c       |
   ...
   | sorting lists                     |       |      | ★☆☆   | d    | c       |
   +-----------------------------------+-------+------+-------+------+---------+
   | iterators and generators          |       |      | ★★★   | d    | c       |
   +-----------------------------------+-------+------+-------+------+---------+
   | comprehensions (list, set & dict) |       |      | ★★☆   | d    | c       |
   ...
   .. - PEP8 ---------------                     
   ..    9        d c line continuations and parens
